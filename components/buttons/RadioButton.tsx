  ...
  return (
    <View className="flex-row items-center">
      <Pressable onPress={onPress} className="my-2 flex-row items-center ">
        <View className="h-6 w-6 items-center justify-center rounded-full border-2 border-gray-400">
          <Animated.View style={animatedStyle} className="h-3 w-3 rounded-full bg-accent" />
        </View>
